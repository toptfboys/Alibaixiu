            ...
            <div class="col-md-4">
                <div class="panel panel-default">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item"><strong><?php echo $comments_count ?></strong>条评论（<strong>1</strong>条待审核）
                        </li>
                    </ul>
                </div>
            </div>
...
<script src="/aliBaixiu/static/assets/vendors/chart/chart.js"></script>
<script>
